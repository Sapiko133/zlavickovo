...
- [x] **C5. Mobile-first + WCAG AA** (29.8.2026, bd0e35b): mobile-first layouty, CTA kontrast (B7), **globálny :focus-visible outline (2.4.7)** overený na prode (fokus viditeľný na nav linkoch), **kontrast sekundárneho textu** #aaa/#999/#888/#bbb → #6b7280 (≥4.5:1) na verejných stránkach, favicony majú alt (1.1.1). Pozn.: exhaustívny screen-reader audit každého páru nie je súčasťou.
