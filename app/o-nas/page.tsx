  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff", fontFamily: "'Inter', system-ui, sans-serif", color: "#1d1d1f" }}>
      ...
      <div style={{ background: "linear-gradient(180deg, #f5f3ff 0%, #fff 100%)", padding: "64px 24px 56px", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 800, letterSpacing: "-1.5px", margin: "0 0 16px" }}>O nás</h1>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "64px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 20, marginBottom: 64 }}>
          {FACTS.map((f, i) => (
            <div key={i} style={{ background: "#fafafa", borderRadius: 16, padding: "28px 24px", border: "1px solid #f0f0f0", textAlign: "center" }}>
        ...
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <h2 style={{ fontSize: 24, fontWeight: 700, letterSpacing: "-0.5px", margin: "0 0 20px" }}>Čo robíme</h2>
          ...
          <div style={{ background: "#f5f3ff", borderRadius: 16, padding: "28px 28px", border: "1px solid rgba(124,58,237,0.15)" }}>
