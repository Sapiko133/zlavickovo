    ...
    <>
            ...
            <div style={{
              ...
              {query && (
                <button onClick={() => { setQuery(""); setDropOpen(false); inputRef.current?.focus(); }}
                  tabIndex={-1}
                  style={{ padding: "0 8px", border: "none", background: "transparent", color: "#6b7280", cursor: "pointer", fontSize: 16, lineHeight: 1 }}>
                  ×
                </button>
              )}
              <button
      ...
      {menuOpen && (
        <div style={{ position: "fixed", inset: 0, zIndex: 500, background: "#fff", overflowY: "auto", display: "flex", flexDirection: "column", fontFamily: "system-ui,-apple-system,sans-serif" }}>
          ...
          <div style={{ padding: "14px 20px 6px", fontSize: 11, fontWeight: 700, color: "#6b7280", letterSpacing: "0.08em", textTransform: "uppercase" }}>Kategórie</div>
